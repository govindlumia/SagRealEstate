...
<body style="margin:0px 0px 0px 0px">
    ...
    <td valign="top" style="text-align:left">
     <%-- <asp:Image ID="imgprvw1" runat="server" Width="380px" Height="105px" style="margin-left:280px;" /> --%>
    <img alt="" src="images/bkr_logo.png" height="100px" width="250px" style="margin-left:350px" />
    </td>
    </tr>
    <tr>
   
    <td style="font-size:14px; font-family:Calibri; font-style:normal; font-weight:bold">
   <%-- <asp:Label ID="lblcompname" runat="server" style="margin-left:300px" ></asp:Label> <asp:Label ID="lbladdress" runat="server" ></asp:Label> <asp:Label ID="lblcity" runat="server" ></asp:Label>
  --%>  </td>
    </tr>
    </table>
   <%-- INVOICE DETAILS--%>
...
<%--    <table cellspacing="0" cellpadding="4" style="float:right; margin:0px 0px -5px; width:300px;" border="1" bordercolor="#8C8C8C" >
--%>	
...
<%--<tr>
    ...
    <td valign="top"><asp:Label ID="lblcusto" runat=server ></asp:Label></td>
	</tr>
    <tr>
...
<tr style="font-weight:bold;"><td valign="top" height="30">
    ...
    <td valign="middle" colspan="8" style="padding-bottom:5px; padding-top:5px ; text-align:left; font-size:15px; padding-left:5px">SALE DESCRIPTION</td>
        ...
        <td width="15%" align="center" valign="middle">Project Name<br />
		 ...
		 <td width="15%" align="center" valign="middle">Area<br />
		 </td>
		<td width="15%" align="center" valign="middle">Rate</td>
		
		<td width="15%" align="center" valign="middle"> Total Cost</td>
		<td width="15%" align="center" valign="middle">Total No. EMI</td>
...
<tr><td valign="top">
	...
	<tr>
        ...
        <td width="15%" valign="top"align="center" style="border-right:2px solid #8C8C8C"><asp:Label ID="lblarea" runat=server ></asp:Label></td>
...
<tr><td>
    ...
    <%--Amount in words:&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="lblAmtWords" runat=server >
    </asp:Label>  &nbsp;  Only--%> 
    </td>
    ...
    <tr>
    <td valign="middle" style="width:140px; padding-bottom:3px; padding-top:3px">Received Amount :</td>
    <td valign="middle" style="padding-bottom:3px; padding-top:3px">
