...
public partial class Agent_show_agent_salary : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            GridView1.DataSource = obj_main.agent_sal_SELECT(obj_main);
            GridView1.DataBind();
        }
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Response.Redirect("agent_salary.aspx?s_no=" + lblserialno.Text);
