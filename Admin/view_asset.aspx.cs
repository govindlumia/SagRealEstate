...
public partial class Admin_view_asset : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            grdLead.DataSource = obj_main.company_assets_SELECT(obj_main);
            grdLead.DataBind();
        }
    ...
    protected void grdLead_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Response.Redirect("asset.aspx?s_no=" + lbls_no.Text);
