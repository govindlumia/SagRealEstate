...
<td valign="middle" style="text-align:right; color:#fff">
 ...
 <div style="width:100%; background-color:#DDDCDD; height:40px;margin-left:0px;margin-bottom:0px;"><p style="margin-left:10px; font-family:Arial; font-size: medium; font-weight: bolder; text-align:left;margin-top:10px; "  >Company Details</p></div>
...
<table width="100%" cellpadding="0" cellspacing="0" class="big" >
   ...
   <td valign="middle" class="dvtCellLabeltop" style="width:200px;">
       <p style="margin-left:10px; font-family: 'Courier New', Courier, monospace; font-size: small; font-weight: bolder; text-align:right;margin-top:10px; width: 112px;"  >COMPANY NAME :</p></td>
  ...
  <td valign="middle" class="dvtCellLabeltop" >  
       <asp:FileUpload ID="filUpload" runat="server" name="filUpload" onchange="showimagepreview(this)" type="file" />
          ...
          <tr>
   <td valign="middle" class="dvtCellLabel">     <p style="margin-left:0px; font-family: 'Courier New', Courier, monospace; font-size: small; font-weight: bolder; text-align:left;margin-top:10px; width: 112px;"  >CORP. OFFICE ADDRESS &nbsp;:</td>
   <td valign="middle" class="cellInfo" style="width:350px"><asp:TextBox ID="txtcorpaddress" runat="server" CssClass="textbox" TextMode="MultiLine" Height="55px" width="220px"></asp:TextBox></td>
   ...
   <td valign="middle"  class="cellInfo" ><asp:TextBox ID="txtcity" runat="server" CssClass="textbox" ></asp:TextBox>
   </td>
      ...
      <td valign="middle"> <asp:Image ID="imgprvw" runat="server" Width="170px" Height="175px" style="margin-top:-10px" /></td>
...
<center>
	...
	<div style="width:100%; background-color:#333333; height:50px;margin-top:0px">
    <table  width="960px">
    <tr>
