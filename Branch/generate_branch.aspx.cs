...
public partial class generate_branch : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            objReader = obj_main.Status_select();
            dd_status.DataSource = objReader;
            dd_status.DataTextField = "status";
            dd_status.DataValueField = "status";
            dd_status.DataBind();
            dd_status.Items.Insert(0, "Select Status");
            dd_status.Items[0].Value = "0";
            dd_status.SelectedValue = "0";
            objReader.Close();
            ...
            if (Request.QueryString["empid"] != null)
            {
                ...
                if (objReader.Read())
                {
                    dd_status.SelectedValue = objReader["active"].ToString();
                    ...
                    Txt_Email.Text = objReader["personal_email"].ToString();
    ...
    protected void submit_Click(object sender, ImageClickEventArgs e)
    {
        ...
        objuser.personal_email = Txt_Email.Text;
       ...
       // objuser.flag = "I";
        objuser.active = dd_status.SelectedValue.ToString();
