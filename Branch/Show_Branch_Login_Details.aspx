<%@ Page Title="SAGONI REAL ESTATE SOFTWARE" Language="C#" MasterPageFile="~/crmmaster.master" AutoEventWireup="true" CodeFile="Show_Branch_Login_Details.aspx.cs" Inherits="Show_Branch_Login_Details" %>
        ...
        <asp:GridView ID="grdLead" runat ="server" AutoGenerateColumns ="False"   GridLines ="None"  
            ...
            PagerStyle-CssClass="pgr" onrowcommand="grdLead_RowCommand1"> 
                         ...
                         <asp:TemplateField  HeaderText ="Action">
                                                ...
                                                <ItemTemplate>
               <asp:ImageButton ID="imgEdit" ImageUrl ="~/images/edit-notes.png" runat="server" Height="20px" CommandName ="edit" ToolTip ="Click to edit" CausesValidation ="false"   /> 
