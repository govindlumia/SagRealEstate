<%@ Page Title="" Language="C#" MasterPageFile="~/crmmaster.master" AutoEventWireup="true" CodeFile="payment.aspx.cs" Inherits="payment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <p class="lvtHeaderText"> Employee Payment</p>
  </div>
...
<table width="98%" cellpadding="0" cellspacing="0" class="big" >
  ...
  <tr>
   ...
   <asp:DropDownList ID="Ddlagent" runat="server" Width="220px" BorderWidth="1px" BorderStyle="Solid" BorderColor="#dddddd" CssClass="dropdown">
    ...
    <td valign="middle"  class="dvtCellLabel"> <asp:Button ID="Button1" CssClass="submit_botton3" runat="server" Text="Submit" 
           onclick="Button1_Click"  /></td>
   <td valign="middle" class="cellInfo1">
   <%--<asp:DropDownList ID="Ddlmonth" runat="server" Width="200px" BorderWidth="1px" BorderStyle="Solid" BorderColor="#dddddd" style=" border-width:1px;height:26px;padding: 2px 2px 2px 5px; color:black; font-size:12px; border-radius:5px">
 ...
 <%--<tr>
   <td valign="middle" colspan="4" class="dvtCellLabel" style="text-align:center;">  
      <br /><br /></td>
