...
public partial class Payment_Agentpayment : System.Web.UI.Page
{
    ...
    {
        objReader = obj_main.agents_payment_view(Ddlagent.SelectedValue.ToString());
        if (objReader.Read())
        {
    ...
    protected void ImageButton1_Click(object sender, EventArgs e)
    {
        ...
        //if (ViewState["flag"].ToString() == "I")
        {
            ...
            value = obj_main.agents_payment_insert(obj_main);
        }
        ...
        Response.Redirect("~/Payment/AgentpaymentDetails.aspx");
