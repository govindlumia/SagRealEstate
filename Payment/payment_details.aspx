<%@ Page Title="" Language="C#" MasterPageFile="~/crmmaster.master" AutoEventWireup="true" CodeFile="payment_details.aspx.cs" Inherits="payment_details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="detailedViewHeader">
  <p class="lvtHeaderText">Employee Payment Details</p>
  </div>
...
<table width="100%" cellpadding="0" cellspacing="0" class="big">
 ...
 <div class="mGrid"    id="Div1" style="width:100%;border-collapse:collapse; padding-top:0px"">
                         ...
                         AllowPaging ="False" Width="100%" EmptyDataText ="No lead found for the criteria you selected." 
