...
public partial class Agent_view_agent_com : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlagent.DataBind();
            ddlagent.Items.Insert(0, "Select All Agent");
           ...
           // obj_main.Branch_Name = Ddlbranchname.SelectedValue.ToString();
            ...
            grdLead.DataSource = obj_main.add_agent_select(obj_main);
            grdLead.DataBind();
    ...
    protected void grdLead_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "edit")
        {
            ...
            Label lblagent_id = (Label)row.FindControl("lblagent_id");
            Response.Redirect("add_agent_com.aspx?agentid=" + lblagent_id.Text);
