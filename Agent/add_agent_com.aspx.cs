...
public partial class Agent_add_agent_com : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["agentid"] != null)
            {
                ...
                objReader = obj_main.add_agent_select_update(Request.QueryString["agentid"].ToString(), 1);
                if (objReader.Read())
                {
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        if (ViewState["flag"].ToString() == "I")
        {
            ...
            value = obj_main.add_agent_insert(obj_main);
        }
        ...
        Response.Redirect("~/Agent/view_agent_com.aspx");
