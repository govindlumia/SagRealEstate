<%@ Page Title="" Language="C#" MasterPageFile="~/crmmaster.master" AutoEventWireup="true" CodeFile="day_calling_report.aspx.cs" Inherits="Day_Report_day_calling_report" Culture="en-GB" UICulture="en-GB" %>
...
<script type ="text/ecmascript" >
  ...
  <p class="lvtHeaderText">Day Calling Report</p>
  </div>
    ...
    <%-- <asp:TemplateField  HeaderText ="Action">
     ...
     <asp:ImageButton ID="imgEdit" ImageUrl ="~/images/quotation-icon.jpg" runat="server" CommandName ="Update" ToolTip ="Click to Update" CausesValidation ="false"   /> 
                           ...
                           <asp:TemplateField HeaderText="s_no" Visible= "false">
                             ...
                             <asp:BoundField DataField ="Customer_name" HeaderText ="Client Name"/>
                             <asp:BoundField DataField ="mobile_no" HeaderText ="Mobile Name"/>
                             <asp:BoundField DataField ="Feedback" HeaderText ="Feedback"/>
                             <asp:BoundField DataField ="nxt_remind_date" HeaderText ="Remind Date "/>
